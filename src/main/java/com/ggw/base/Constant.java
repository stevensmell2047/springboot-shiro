...
/**
 * @author qizhuo
 * @since 2022-05-26 12:27:33
 */
public class Constant {

  public static final String TOKEN_KEY_NAME = "token";
  public static final String DEFAULT_FAIL = "操作失败";
  ...
  public static class FilePostFix {
    ...
    public static final String[] VIDEO = {"mp4", "MP4", "mpg", "mpe", "mpa", "m15", "m1v", "mp2",
        "rmvb"};
